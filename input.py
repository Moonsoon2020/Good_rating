...
class Ui_MainWindow_Input(object):
    def setupUi(self, MainWindow):
        ...
        self.label_info.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByKeyboard|QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextBrowserInteraction|QtCore.Qt.TextEditable|QtCore.Qt.TextEditorInteraction|QtCore.Qt.TextSelectableByKeyboard|QtCore.Qt.TextSelectableByMouse)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox.setText(_translate("MainWindow", "Я согласен предоставить свои персональные данные приложению Good Rating. "))
        self.label_login.setText(_translate("MainWindow", "Login"))
        self.label_password.setText(_translate("MainWindow", "Password"))
        self.label_info.setText(_translate("MainWindow", "<html><head/><body><p align=\"justify\"><span style=\" font-size:12pt; font-weight:600;\">Good Rating </span><span style=\" font-size:12pt;\">- приложение-дополнение для электронного дневника Нижегородской области. Теперь Вам не прийдётся считать: сколько вам нужно получить пятёрок, чтобы в четверти вышла 5, или на какую максимально плохую оценку я могу написать контрольную. </span></p><p align=\"right\"><span style=\" font-size:12pt;\">Приложение работает для </span><span style=\" font-size:12pt; text-decoration: underline;\">всех учеников зарегистрированных на платформе</span><span style=\" font-size:12pt;\">. </span></p></body></html>"))
        self.label_dop_ifo.setText(_translate("MainWindow", "<html><head/><body><p align=\"justify\"><span style=\" font-size:12pt;\"> Пожалуйста, введите логин и пароль.</span></p></body></html>"))
